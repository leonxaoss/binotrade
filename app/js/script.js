(function(){
    ...
    function readF(){
        ...
        const headerBlockR = document.querySelector('.header_block__right');
    ...
    function scrollElemAdd(selector, selectorChange, param){
        ...
        function scrollElem() {
            ...
            for (let i = 0; i < scrollElement.length; i++) {
                const coordinateTop = scrollElement[i].getBoundingClientRect().top,
